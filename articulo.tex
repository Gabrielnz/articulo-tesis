...
\section{Bases Te\'{o}ricas}
	...
	\subsection{Antecedentes}
		\subsubsection{Coordenadas de cromaticidad y espacio CIE (L*a*b*)}
			las coordenadas de cromaticidad CIE (XYZ) 1964, representan los valores triest\'{i}mulo de un color siguiendo el est\'{a}ndar definido por la \textit{\mbox{Commission} Internationale de l'Eclairage} \cite{CIE}; el espacio CIE (L*a*b*) 1976, es un sistema para la \mbox{transformaci\'{o}n} de tales coordenadas, definido tambi\'{e}n por la \textit{CIE}. Los procedimientos empleados para el c\'{a}lculo de las coordenadas y del espacio de transformaci\'{o}n definidos \cite{Schanda}, est\'{a}n siendo implementados en el nuevo software para determinar ciertas propiedades \'{o}pticas presentes en la piel de los pacientes.
