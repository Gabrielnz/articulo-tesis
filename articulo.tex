...
\section{Resultados y Conclusiones}
	...
	El software resultante, denominado Spectrasoft, se puede apreciar en la figura 2. Este software resultante dispone de las funciones listadas en la tabla 3.
...
\FloatBarrier
		\begin{table}[H]
			...
			\begin{tabulary}{8.8cm}{|c|J|}
				\hline
				\thead{\textbf{\#}} & \thead{\textbf{Funci\'{o}n}}\\ \hline
