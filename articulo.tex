...
\section{Antecedentes y Recursos}
...
\section{Metodolog\'{i}as}
	\subsection{Investigaci\'{o}n-Acci\'{o}n}
		...
		Las actividades de la investigaci\'{o}n se est\'{a}n realizando seg\'{u}n la representaci\'{o}n m\'{a}s habitual de la Investigaci\'{o}n-Acci\'{o}n \cite{Baskerville},  son las descritas en la Tabla 1.
	
%	\begin{figure}[H]
%		\caption{FIGURA I.    Car\'{a}cter c\'{i}clico de Investigaci\'{o}n-Acci%\'{o}n}
%		\label{figura_1}
%		\centering
%		\includegraphics[scale=0.61]{img/investigacion-accion.png}
%	\end{figure}
