...
\vfill
	...
	\subsection{SCRUM}
		...
		Adicionalmente a la utilizaci\'{o}n de la metodolog\'{i}a SCRUM, se incluyeron algunos artefactos de la metodolog\'{i}a RUP \cite{Kroll&Kruchten}, para as\'{i} generar suficiente documentaci\'{o}n relevante, y asegurar el criterio de mantenibilidad. La configuraci\'{o}n de la metodolog\'{i}a SCRUM, en conjunto con los artefactos seleccionados de la metodolog\'{i}a RUP, se ilustra en la \mbox{tabla 2}.
...
\vfill
		...
		\begin{table}[htb]
			...
			\begin{tabulary}{8.8cm}{|J|}
				...
				\textbf{Pila del \textit{sprint}: }el grupo de tareas que se deben realizar durante un \textit{sprint}.\\ \hline
