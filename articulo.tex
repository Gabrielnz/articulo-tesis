...
\section{Antecedentes}
	...
	\subsection{Antecedentes de la investigaci\'{o}n}
		...
		este \'{i}ndice es utilizado para determinar el nivel inflamatorio de la epidermis de un paciente. El m\'{e}todo aplicado para calcular este \'{i}ndice \cite{Wagner} est\'{a} siendo implementado en el nuevo software.
		
		\subsubsection{Coeficiente de absorci\'{o}n de la epidermis}
			 su objetivo es indicar el nivel de concentraci\'{o}n de melanina presente en la epidermis de un paciente. La t\'{e}cnica empleada para recuperar este coeficiente \cite{Narea} est\'{a} siendo implementada en el nuevo software.
