...
\section{Materiales, Tecnolog\'{i}as y M\'{e}todos}
	\subsection{Tecnolog\'{i}as}
		\subsubsection{Qt}
			Es un framework de dise\~{n}o, desarrollo e implementaci\'{o}n de software escrito en C++, que provee un entorno integrado de desarrollo (IDE) multi-plataforma.
